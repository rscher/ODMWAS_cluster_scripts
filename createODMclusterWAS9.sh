...
$WAS_HOME/bin/manageprofiles.sh -create -templatePath $WAS_HOME/profileTemplates/managed  -profileName $node01ProfileName -profilePath $WAS_NODE01  -nodeName $node1Name
